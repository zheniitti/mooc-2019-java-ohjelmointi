...
public class HiekkarantaSovellus extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Button rbut = new Button("Restart");
        rbut.setOnMouseClicked(value->{simulaatio.tyhjenna();});
        ...
        VBox napit = new VBox();
        napit.getChildren().addAll(metalli, hiekka, vesi, rbut);
