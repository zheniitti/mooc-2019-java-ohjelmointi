...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ajoneuvorekisteri ajorek = new Ajoneuvorekisteri();
        ajorek.lisaa(rek3, "Jurgen"); ajorek.lisaa(rek1, "Arton"); ajorek.lisaa(rek2, "Arton");
        ajorek.tulostaOmistajat(); ajorek.tulostaRekisterinumerot();
